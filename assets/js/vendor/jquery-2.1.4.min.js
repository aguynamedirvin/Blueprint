 ...
 */
    ...
    function cloneCopyEvent(src, dest) {
        ...
        if (1 === dest.nodeType) {
            ...
            pdataCur = data_priv.set(dest, pdataOld), events = pdataOld.events)) {
                delete pdataCur.handle, pdataCur.events = {};
                for (type in events) for (i = 0, l = events[type].length; l > i; i++) jQuery.event.add(dest, type, events[type][i]);
            }
            // 2. Copy user data
            data_user.hasData(src) && (udataOld = data_user.access(src), 
            udataCur = jQuery.extend({}, udataOld), data_user.set(dest, udataCur));
        }
    }
 ...
 */
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        each: function(obj, callback, args) {
            ...
            if (args) {
                if (isArray) for (;length > i && (value = callback.apply(obj[i], args), 
                value !== !1); i++) ; else for (i in obj) if (value = callback.apply(obj[i], args), 
                value === !1) break;
 ...
 */
    function(window) {
        function Sizzle(selector, context, results, seed) {
            ...
            nodeType = context.nodeType, "string" != typeof selector || !selector || 1 !== nodeType && 9 !== nodeType && 11 !== nodeType) return results;
 ...
 */
        ...
        function addCombinator(matcher, combinator, base) {
            ...
            return combinator.first ? function(elem, context, xml) {
                ...
                if (xml) {
                    ...
                    (oldCache = outerCache[dir]) && oldCache[0] === dirruns && oldCache[1] === doneName) // Assign to newCache so results back-propagate to previous elements
        ...
        support = Sizzle.support = {}, isXML = Sizzle.isXML = function(elem) {
            ...
            docElem = doc.documentElement, parent = doc.defaultView, 
                    ...
                    return 1 === first && 0 === last ? function(elem) {
                        ...
                        if (parent) {
                            ...
                            forward && useCache) {
                                ...
                                cache = outerCache[type] || [], nodeIndex = cache[0] === dirruns && cache[1], 
 ...
 */
    ...
    jQuery.expr[":"] = jQuery.expr.pseudos, jQuery.unique = Sizzle.uniqueSort, 
    ...
    rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, init = jQuery.fn.init = function(selector, context) {
        ...
        this.length = 1, this) : jQuery.isFunction(selector) ? "undefined" != typeof rootjQuery.ready ? rootjQuery.ready(selector) : selector(jQuery) : (void 0 !== selector.selector && (this.selector = selector.selector, 
 ...
 */
    jQuery.Callbacks = function(options) {
        ...
        fire = function(data) {
            for (memory = options.memory && data, fired = !0, 
            firingIndex = firingStart || 0, firingStart = 0, firingLength = list.length, 
            firing = !0; list && firingLength > firingIndex; firingIndex++) if (list[firingIndex].apply(data[0], data[1]) === !1 && options.stopOnFalse) {
                memory = !1;
        ...
        when: function(subordinate) {
            ...
            progressContexts = new Array(length), resolveContexts = new Array(length); length > i; i++) resolveValues[i] && jQuery.isFunction(resolveValues[i].promise) ? resolveValues[i].promise().done(updateFunc(i, resolveContexts, resolveValues)).fail(deferred.reject).progress(updateFunc(i, progressContexts, progressValues)) : --remaining;
 ...
 */
    ...
    jQuery.extend({
        ...
        promise: function(type, obj) {
            ...
            type = type || "fx"; i--; ) tmp = data_priv.get(elements[i], type + "queueHooks"), 
 ...
 */
    jQuery.event = {
        ...
        add: function(elem, types, handler, data, selector) {
            ...
            handlers.delegateCount = 0, special.setup && special.setup.call(elem, data, namespaces, eventHandle) !== !1 || elem.addEventListener && elem.addEventListener(type, eventHandle, !1)), 
    ...
    support.focusinBubbles || jQuery.each({
        ...
        on: function(types, selector, data, fn, /*INTERNAL*/ one) {
            ...
            fn === !1) fn = returnFalse; else if (!fn) return this;
    ...
    wrapMap.th = wrapMap.td, jQuery.extend({
        ...
        replaceWith: function() {
            ...
            return this.domManip(arguments, function(elem) {
                arg = this.parentNode, jQuery.cleanData(getAll(this)), 
    ...
    !function() {
        ...
        window.getComputedStyle && jQuery.extend(support, {
            ...
            reliableMarginRight: function() {
                ...
                div.style.width = "1px", docElem.appendChild(container), 
                ret = !parseFloat(window.getComputedStyle(marginDiv, null).marginRight), 
                docElem.removeChild(container), div.removeChild(marginDiv), 
                ret;
            }
        }));
    ...
    var fxNow, timerId, rfxtypes = /^(?:toggle|show|hide)$/, rfxnum = new RegExp("^(?:([+-])=|)(" + pnum + ")([a-z%]*)$", "i"), rrun = /queueHooks$/, animationPrefilters = [ defaultPrefilter ], tweeners = {
        "*": [ function(prop, value) {
            ...
            tween.unit = unit, tween.end = parts[1] ? start + (parts[1] + 1) * parts[2] : +parts[2]), 
            tween;
        } ]
    };
    ...
    jQuery.extend({
		...
		*/
        ...
        jQuery[method] = function(url, data, callback, type) {
            ...
            callback = data, data = void 0), jQuery.ajax({
                url: url,
                type: method,
                dataType: type,
                data: data,
