 ...
 */
    ...
    function adjustCSS(elem, prop, valueParts, tween) {
        ...
        if (initialInUnit && initialInUnit[3] !== unit) {
            ...
            do scale = scale || ".5", initialInUnit /= scale, 
            jQuery.style(elem, prop, initialInUnit + unit); while (scale !== (scale = currentValue() / initial) && 1 !== scale && --maxIterations);
        }
        // Apply relative offset (+=/-=) if specified
        return valueParts && (initialInUnit = +initialInUnit || +initial || 0, 
        adjusted = valueParts[1] ? initialInUnit + (valueParts[1] + 1) * valueParts[2] : +valueParts[2], 
        tween && (tween.unit = unit, tween.start = initialInUnit, 
        tween.end = adjusted)), adjusted;
    }
    ...
    function buildFragment(elems, context, scripts, selection, ignored) {
        ...
        if ("object" === jQuery.type(elem)) // Support: Android<4.1, PhantomJS<2
    ...
    function on(elem, types, selector, data, fn, one) {
        ...
        fn === !1) fn = returnFalse; else if (!fn) return elem;
    ...
    function cloneCopyEvent(src, dest) {
        ...
        if (1 === dest.nodeType) {
            ...
            pdataCur = dataPriv.set(dest, pdataOld), events = pdataOld.events)) {
                delete pdataCur.handle, pdataCur.events = {};
                for (type in events) for (i = 0, l = events[type].length; l > i; i++) jQuery.event.add(dest, type, events[type][i]);
            }
            // 2. Copy user data
            dataUser.hasData(src) && (udataOld = dataUser.access(src), 
            udataCur = jQuery.extend({}, udataOld), dataUser.set(dest, udataCur));
        }
    }
    ...
    function domManip(collection, args, callback, ignored) {
        ...
        first || ignored)) {
            ...
            hasScripts = scripts.length; l > i; i++) node = fragment, 
 ...
 */
    function defaultDisplay(nodeName) {
        ...
        doc = iframe[0].contentDocument, doc.write(), doc.close(), 
    ...
    function curCSS(elem, name, computed) {
        ...
        ret = computed.width, style.width = width, style.minWidth = minWidth, 
    ...
    function getWidthOrHeight(elem, name, extra) {
        ...
        document.msFullscreenElement && window.top !== window && elem.getClientRects().length && (val = Math.round(100 * elem.getBoundingClientRect()[name])), 
        0 >= val || null == val) {
    ...
    function createTween(value, prop, animation) {
        for (var tween, collection = (Animation.tweeners[prop] || []).concat(Animation.tweeners["*"]), index = 0, length = collection.length; length > index; index++) if (tween = collection[index].call(animation, prop, value)) // We're done with this property
        return tween;
    }
    function defaultPrefilter(elem, props, opts) {
        ...
        null == hooks.unqueued && (hooks.unqueued = 0, oldfire = hooks.empty.fire, 
    ...
    function propFilter(props, specialEasing) {
        ...
        for (index in props) if (name = jQuery.camelCase(index), 
        easing = specialEasing[name], value = props[index], 
        jQuery.isArray(value) && (easing = value[1], value = props[index] = value[0]), 
        index !== name && (props[name] = value, delete props[index]), 
        hooks = jQuery.cssHooks[name], hooks && "expand" in hooks) {
            value = hooks.expand(value), delete props[name];
            // Not quite $.extend, this won't overwrite existing keys.
            // Reusing 'index' because we have the correct "name"
            for (index in value) index in props || (props[index] = value[index], 
    ...
    function Animation(elem, properties, options) {
        var result, stopped, index = 0, length = Animation.prefilters.length, deferred = jQuery.Deferred().always(function() {
            ...
            if (stopped) return !1;
            for (var currentTime = fxNow || createFxNow(), remaining = Math.max(0, animation.startTime + animation.duration - currentTime), // Support: Android 2.3
 ...
 */
    function ajaxConvert(s, response, jqXHR, isSuccess) {
        ...
        if ("*" === current) current = prev; else if ("*" !== prev && prev !== current) {
            ...
            !conv) for (conv2 in converters) if (tmp = conv2.split(" "), 
 ...
 */
    ...
    //"use strict";
    var arr = [], document = window.document, slice = arr.slice, concat = arr.concat, push = arr.push, indexOf = arr.indexOf, class2type = {}, toString = class2type.toString, hasOwn = class2type.hasOwnProperty, support = {}, version = "2.2.1", // Define a local copy of jQuery
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        pushStack: function(elems) {
            ...
            return ret.prevObject = this, ret.context = this.context, 
            ret;
        },
        ...
        "boolean" == typeof target && (deep = target, target = arguments[i] || {}, 
        ...
        isPlainObject: function(obj) {
            ...
            // - DOM nodes
            // - window
            return "object" !== jQuery.type(obj) || obj.nodeType || jQuery.isWindow(obj) ? !1 : !obj.constructor || hasOwn.call(obj.constructor.prototype, "isPrototypeOf");
        },
        ...
        proxy: function(fn, context) {
            ...
            context = fn, fn = tmp), jQuery.isFunction(fn) ? (args = slice.call(arguments, 2), 
            proxy = function() {
        ...
        function addCombinator(matcher, combinator, base) {
            ...
            return combinator.first ? function(elem, context, xml) {
                ...
                if (xml) {
                    ...
                    (oldCache = uniqueCache[dir]) && oldCache[0] === dirruns && oldCache[1] === doneName) // Assign to newCache so results back-propagate to previous elements
                    return newCache[2] = oldCache[2];
                    // A match means we're done; a fail means we have to keep checking
                    if (// Reuse newcache so results back-propagate to previous elements
                    uniqueCache[dir] = newCache, newCache[2] = matcher(elem, context, xml)) return !0;
                }
            };
        }
                ...
                CHILD: function(type, what, argument, first, last) {
                    ...
                    return 1 === first && 0 === last ? function(elem) {
                        ...
                        if (parent) {
                            ...
                            forward && useCache) {
                                for (node = parent, outerCache = node[expando] || (node[expando] = {}), 
                                uniqueCache = outerCache[node.uniqueID] || (outerCache[node.uniqueID] = {}), 
                                cache = uniqueCache[type] || [], nodeIndex = cache[0] === dirruns && cache[1], 
                                diff = nodeIndex && cache[2], node = nodeIndex && parent.childNodes[nodeIndex]; node = ++nodeIndex && node && node[dir] || (diff = nodeIndex = 0) || start.pop(); ) if (1 === node.nodeType && ++diff && node === elem) {
                            ...
                            uniqueCache = outerCache[node.uniqueID] || (outerCache[node.uniqueID] = {}), 
                            cache = uniqueCache[type] || [], nodeIndex = cache[0] === dirruns && cache[1], 
                            diff = nodeIndex), diff === !1) for (;(node = ++nodeIndex && node && node[dir] || (diff = nodeIndex = 0) || start.pop()) && ((ofType ? node.nodeName.toLowerCase() !== name : 1 !== node.nodeType) || !++diff || (useCache && (outerCache = node[expando] || (node[expando] = {}), 
                            uniqueCache = outerCache[node.uniqueID] || (outerCache[node.uniqueID] = {}), 
                            uniqueCache[type] = [ dirruns, diff ]), node !== elem)); ) ;
 ...
 */
        ...
        Expr.setFilters = new setFilters(), tokenize = Sizzle.tokenize = function(selector, parseOnly) {
            ...
            if (results = results || [], 1 === match.length) {
                ...
                !Expr.relative[type = token.type]); ) if ((find = Expr.find[type]) && (seed = find(token.matches[0].replace(runescape, funescape), rsibling.test(tokens[0].type) && testContext(context.parentNode) || context))) {
                    ...
                    !selector) return push.apply(results, seed), results;
                    break;
                }
            }
    ...
    rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, init = jQuery.fn.init = function(selector, context, root) {
        ...
        if (root = root || rootjQuery, "string" == typeof selector) {
            ...
            this[0] = elem), this.context = document, this.selector = selector, 
            this;
        }
        // Execute immediately if ready is not present
        return selector.nodeType ? (this.context = this[0] = selector, 
        this.length = 1, this) : jQuery.isFunction(selector) ? void 0 !== root.ready ? root.ready(selector) : selector(jQuery) : (void 0 !== selector.selector && (this.selector = selector.selector, 
 ...
 */
    jQuery.Callbacks = function(options) {
        ...
        self = {
            ...
            lock: function() {
                return locked = queue = [], memory || (list = memory = ""), 
                this;
            },
            locked: function() {
                return !!locked;
        ...
        when: function(subordinate) {
            ...
            remaining = 1 !== length || subordinate && jQuery.isFunction(subordinate.promise) ? length : 0, // the master Deferred.
            ...
            if (length > 1) for (progressValues = new Array(length), 
            progressContexts = new Array(length), resolveContexts = new Array(length); length > i; i++) resolveValues[i] && jQuery.isFunction(resolveValues[i].promise) ? resolveValues[i].promise().progress(updateFunc(i, progressContexts, progressValues)).done(updateFunc(i, resolveContexts, resolveValues)).fail(deferred.reject) : --remaining;
    ...
    var access = function(elems, fn, key, value, chainable, emptyGet, raw) {
        ...
        bulk && (raw ? (fn.call(elems, value), fn = null) : (bulk = fn, 
    ...
    Data.uid = 1, Data.prototype = {
        ...
        set: function(owner, data, value) {
            ...
            if ("string" == typeof data) cache[data] = value; else // Copy the properties one-by-one to the cache object
    ...
    jQuery.extend({
        ...
        data: function(key, value) {
            ...
            return "object" == typeof key ? this.each(function() {
                ...
                if (elem && void 0 === value) {
                    if (data = dataUser.get(elem, key) || // Try to find dashed key if it exists (gh-2779)
                    // This is for 2.2.x only
                    dataUser.get(elem, key.replace(rmultiDash, "-$&").toLowerCase()), 
                    void 0 !== data) return data;
                    if (camelKey = jQuery.camelCase(key), data = dataUser.get(elem, camelKey), 
                    void 0 !== data) return data;
        ...
        dequeue: function(elem, type) {
            ...
            fn && (// Add a progress sentinel to prevent the fx queue from being
        ...
        promise: function(type, obj) {
            ...
            type = type || "fx"; i--; ) tmp = dataPriv.get(elements[i], type + "queueHooks"), 
    ...
    !function() {
        ...
        input.setAttribute("type", "radio"), input.setAttribute("checked", "checked"), 
 ...
 */
    jQuery.event = {
        ...
        add: function(elem, types, handler, data, selector) {
            ...
            t = types.length; t--; ) tmp = rtypenamespace.exec(types[t]) || [], 
            type = origType = tmp[1], namespaces = (tmp[2] || "").split(".").sort(), 
            type && (special = jQuery.event.special[type] || {}, 
            type = (selector ? special.delegateType : special.bindType) || type, 
            special = jQuery.event.special[type] || {}, handleObj = jQuery.extend({
                type: type,
                origType: origType,
                data: data,
                handler: handler,
            ...
            }, handleObjIn), (handlers = events[type]) || (handlers = events[type] = [], 
            handlers.delegateCount = 0, special.setup && special.setup.call(elem, data, namespaces, eventHandle) !== !1 || elem.addEventListener && elem.addEventListener(type, eventHandle)), 
        ...
        remove: function(elem, types, handler, selector, mappedTypes) {
            ...
            if (elemData && (events = elemData.events)) {
                ...
                types = (types || "").match(rnotwhite) || [ "" ], 
                t = types.length; t--; ) // Unbind all events (on this namespace, if provided) for the element
                if (tmp = rtypenamespace.exec(types[t]) || [], type = origType = tmp[1], 
        ...
        handlers: function(event, handlers) {
            ...
            if (delegateCount && cur.nodeType && ("click" !== event.type || isNaN(event.button) || event.button < 1)) for (;cur !== this; cur = cur.parentNode || this) // Don't check non-elements (#13208)
            // Don't process clicks on disabled elements (#6911, #8165, #11382, #11764)
            if (1 === cur.nodeType && (cur.disabled !== !0 || "click" !== event.type)) {
                for (matches = [], i = 0; delegateCount > i; i++) handleObj = handlers[i], 
                sel = handleObj.selector + " ", void 0 === matches[sel] && (matches[sel] = handleObj.needsContext ? jQuery(sel, this).index(cur) > -1 : jQuery.find(sel, this, null, [ cur ]).length), 
        ...
        fix: function(event) {
            ...
            event = new jQuery.Event(originalEvent), i = copy.length; i--; ) prop = copy[i], 
    ...
    jQuery.extend({
        ...
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
            ...
            destElements = destElements || getAll(clone), i = 0, 
            l = srcElements.length; l > i; i++) cloneCopyEvent(srcElements[i], destElements[i]); else cloneCopyEvent(elem, clone);
    ...
    !function() {
        ...
        container.appendChild(div), jQuery.extend(support, {
            ...
            reliableMarginRight: function() {
                ...
                div.style.width = "1px", documentElement.appendChild(container), 
                ret = !parseFloat(window.getComputedStyle(marginDiv).marginRight), 
                documentElement.removeChild(container), div.removeChild(marginDiv), 
                ret;
            }
        }));
    }();
    ...
    jQuery.Animation = jQuery.extend(Animation, {
        ...
        stop: function(type, clearQueue, gotoEnd) {
            ...
            clearQueue = type, type = void 0), clearQueue && type !== !1 && this.queue(type || "fx", []), 
            this.each(function() {
    ...
    jQuery.fn.delay = function(time, type) {
        ...
        type = type || "fx", this.queue(type, function(next, hooks) {
        ...
        input = document.createElement("input"), input.value = "t", 
            ...
            type: {
                set: function(elem, value) {
                    if (!support.radioValue && "radio" === value && jQuery.nodeName(elem, "input")) {
                        var val = elem.value;
                        return elem.setAttribute("type", value), val && (elem.value = val), 
                        value;
                    }
                }
            }
    ...
    jQuery.fn.extend({
        ...
        toggleClass: function(value, stateVal) {
            ...
            return "boolean" == typeof stateVal && "string" === type ? stateVal ? this.addClass(value) : this.removeClass(value) : jQuery.isFunction(value) ? this.each(function(i) {
                ...
                if ("string" === type) for (i = 0, self = jQuery(this), 
                classNames = value.match(rnotwhite) || []; className = classNames[i++]; ) self.hasClass(className) ? self.removeClass(className) : self.addClass(className); else void 0 !== value && "boolean" !== type || (className = getClass(this), 
        ...
        valHooks: {
            ...
            select: {
                get: function(elem) {
                    ...
                    for (var value, option, options = elem.options, index = elem.selectedIndex, one = "select-one" === elem.type || 0 > index, values = one ? null : [], max = one ? index + 1 : options.length, i = 0 > index ? max : one ? index : 0; max > i; i++) // IE8-9 doesn't update selected after form reset (#2551)
    ...
    jQuery.extend(jQuery.event, {
        trigger: function(event, data, elem, onlyHandlers) {
            ...
            special = jQuery.event.special[type] || {}, onlyHandlers || !special.trigger || special.trigger.apply(elem, data) !== !1)) {
                ...
                handle && handle.apply(cur, data), handle = ontype && cur[ontype], 
                ...
                tmp && (elem[ontype] = null), jQuery.event.triggered = type, 
                elem[type](), jQuery.event.triggered = void 0, tmp && (elem[ontype] = tmp)), 
                event.result;
            }
        },
		...
		*/
        ...
        ajax: function(url, options) {
            ...
            function done(status, nativeStatusText, responses, headers) {
                ...
                // Called once
                2 !== state && (state = 2, timeoutTimer && window.clearTimeout(timeoutTimer), 
                transport = void 0, responseHeadersString = headers || "", 
                jqXHR.readyState = status > 0 ? 4 : 0, isSuccess = status >= 200 && 300 > status || 304 === status, 
                ...
                jqXHR.statusCode(statusCode), statusCode = void 0, 
            ...
            jqXHR = {
                ...
                abort: function(statusText) {
                    ...
                    return transport && transport.abort(finalText), done(0, finalText), 
                    this;
                }
            };
        ...
        jQuery[method] = function(url, data, callback, type) {
            ...
            callback = data, data = void 0), jQuery.ajax(jQuery.extend({
                url: url,
                type: method,
                dataType: type,
                data: data,
    ...
    jQuery.parseHTML = function(data, context, keepScripts) {
        ...
        context = !1), // Stop scripts or inline event handlers from being executed immediately
 ...
 */
    ...
    jQuery.each([ "ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend" ], function(i, type) {
        ...
        setOffset: function(elem, options, i) {
            ...
            curCSSLeft = jQuery.css(elem, "left"), calculatePosition = ("absolute" === position || "fixed" === position) && (curCSSTop + curCSSLeft).indexOf("auto") > -1, 
            calculatePosition ? (curPosition = curElem.position(), 
            curTop = curPosition.top, curLeft = curPosition.left) : (curTop = parseFloat(curCSSTop) || 0, 
            curLeft = parseFloat(curCSSLeft) || 0), jQuery.isFunction(options) && (options = options.call(elem, i, jQuery.extend({}, curOffset))), 
        ...
        offset: function(options) {
            ...
            return docElem = doc.documentElement, jQuery.contains(docElem, elem) ? (box = elem.getBoundingClientRect(), 
            win = getWindow(doc), {
